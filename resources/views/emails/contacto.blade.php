...
<body>
    ...
    <section class="bg-green-500">
        <div class="p-8">
            ...
            <div class="mb-2">
                <p><strong>Pais: </strong>{{$contacto['pais']}}</p>
            </div>
            <div class="mb-2">
                <p><strong>Url: </strong>{{$contacto['url']}}</p>
            </div>
            <div class="mb-2">
                <p><strong>Sector: </strong>{{$contacto['sector']}}</p>
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
                <p><strong>Presupuesto: </strong>{{$contacto['presupuesto']}}</p>
            </div>
        </div>
        <div class="mt-4 text-white font-bold text-center">
            <small class="text-green-900">© {{ date('Y') }} Trepstom. Todos los derechos reservados.</small>
        </div>
    </section>
</body>
